            ...
            <div class="uk-width-3-5@s">
                <ul class="uk-breadcrumb">
                    <li class="uk-disabled">
                        <span class="uk-h1 uk-text-large uk-text-uppercase">{{tag_data.name}}</span></li>
    ...
    export default {
        ...
        methods: {
            ...
            getList: function () {
                ...
                data.min = this.min_;
                data.max = this.max_;
                this.$http.post('/product/get/list_by_tag', data).then(response => {
                    this.list = response.data.list;
                    this.page_list = response.data.page_list;
                    this.pages = response.data.pages;
                    this.tag_data = response.data.tag_data;

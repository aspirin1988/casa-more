            ...
            <div v-if="list.length">
                ...
                <ul class="uk-comment-list">
                    <li v-for="item in list">
                        <brand_list_item-component :item="item" :key="item.id" @Delete="Delete"></brand_list_item-component>
                    </li>
                </ul>
...
<script>
    export default {
        ...
        methods: {
            getList:function () {
                this.$http.get('/admin/brand/get/' + this.current_page).then(response => {

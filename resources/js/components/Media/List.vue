    ...
    <div>
            ...
            <div v-if="list.length">
                ...
                <ul class="media-grid">
                    <li v-for="item in list">
                        <media_list_item-component :item="item" :key="item.id"
                                                   @Delete="Delete"></media_list_item-component>
                    </li>
                </ul>
        ...
        <div id="delete-save" ref="delete-save" uk-modal>
            <div class="uk-modal-dialog uk-modal-body">
                ...
                <p> Вы действительно хотите удалить директорию?</p>
...
<script>
    export default {
        ...
        methods: {
            getList: function () {
                this.$http.get('/admin/image/get_dir/' + this.current_page).then(response => {
            ...
            deletePage: function (item) {
                this.$http.delete('/admin/media/delete/' + this.delete_item.dir_name).then(response => {

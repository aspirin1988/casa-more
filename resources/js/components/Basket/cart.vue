                ...
                <div class="FormInWr container sixteen columns">
                    ...
                    <div class="form">
                        ...
                        <div class="CartBottomText">
                            ...
                            <p>Доставка массажного, фитнес оборудования, а также товаров по уходу за телом и для дома Casa&More стоимостью более 10 000 тенге осуществляется бесплатно.
                                Самовывоз товара возможен во всех торговых точках компании по г. Алматы.
                                <br>
                                Подробнее Вы можете прочитать <a href="/delivery/">здесь</a>.</p>
                        </div>
                        ...
                        <div class="tab-form active" style="justify-content: center; width: 100%;" v-if="{'active':!pay}" >
                            <button @click="sendOrder" class="FormInBtn">Перейти к оплате</button>
                        </div>
                        <div class="tab-form active" style="justify-content: center; width: 100%;" v-else="" >

            ...
            <div clas="ProdPostVarWr">
                ...
                <div class="ProdPostVarSubmit">
                    ...
                    @if( $object->caspian_link)
                        <a href="{{$object->caspian_link}}" target="_blank" class="SiteBtn SiteBtnCaspi" type="button">

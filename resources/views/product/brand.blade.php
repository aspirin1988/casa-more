    ...
    <section class="tabs uk-margin-medium">
        <div class="uk-container">
                ...
                <div class="uk-width-3-5@s">
                    <ul class="uk-breadcrumb">
                        <li class="uk-disabled"><h1><span
                                        class="uk-text-large uk-text-uppercase">{{$brand->name}}</span></h1></li>
                        <li><a href="/all-brands">Бренды</a></li>
            ...
            <ul class="uk-pagination uk-flex-center" uk-margin>
                ...
                <li><a href="/{{$brand->keyword}}/?p=1">1</a></li>
                <li><a href="/{{$brand->keyword}}/?p=2">2</a></li>
                <li><a href="/{{$brand->keyword}}/?p=3">3</a></li>

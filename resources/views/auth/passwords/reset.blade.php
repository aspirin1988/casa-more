            ...
            <div class="FormInWr container sixteen columns">
                ...
                <div id="form-1" class="tab-form active">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <label>
                            <span>E-mail:</span>
                            <input type="email" name="email" value="{{ $email ?? old('email') }}" class="text" required autocomplete="email" autofocus>
                        </label>
                        <label>
                            <span>Пароль:</span>
                        ...
                        <button type="submit" class="FormBtn">{{ __('passwords.Reset Password_') }}</button>
                        @if ($errors->has('email'))
